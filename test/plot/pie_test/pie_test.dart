...
void main() {
  ...
  group('pie plot', () {
    test('plot simple', () async {
      ...
      var plotExample = canvasPie(series: series, pies: [line1, line2, line3],
    ...
    test('plot slice custom', () async {
      ...
      var line1 = PlotPie(fill: Color.blue, stroke: Color.black, strokeWidth: StrokeWidth.width5, strokeDasharray: StrokeDasharray.dash2);
      var line2 = PlotPie(fill: Color.red);
      var line3 = PlotPie(fill: Color.green);
      ...
      var plotExample = canvasPie(title: 'some title to test', series: series, pies: [line1, line2, line3],
          legend: Legend([legend1, legend2, legend3], LegendPosition.bottomRight));
