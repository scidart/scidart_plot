...
void main() {
  ...
  group('stem plot', () {
    test('stem simple', () async {
      ...
      var line = PlotGeneral(ay: sg, plotGeneralType: PlotGeneralType.Stem);
      var plotExample = canvasGeneral(ax: n, lines: [line]);

      await saveSvg(plotExample, directory + 'stemSimple');
    });

    test('stem big set', () async {
      var N = 0.1;
      ...
      await saveSvg(plotExample, directory + 'stemBigSet');
    });

    test('stem 1 lines 2 dashed Legend top right big text title line filled',
        () async {
      var N = 0.1;
      var n = linspace(0, N, num: 50, endpoint: false);
      var f1 = 60.0;
      ...
      await saveSvg(plotExample,
          directory + 'stem1Lines2DashedLegendTopRightBigTextTitleLineFilled');
    });
  });
}
